...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.PUT("/rankings/privacy", middleware.UserAuth(), controller.UpdateRankingPrivacy)
		...
		apiRouter.GET("/reset_password", middleware.CriticalRateLimit(), middleware.TurnstileCheck(), controller.ResetPasswordByQQ)
		...
		apiRouter.POST("/xzn-pay/webhook", controller.XznPayWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/token/self", controller.GetAccessToken)
				...
				selfRoute.POST("/xzn-pay/pay", middleware.CriticalRateLimit(), controller.RequestXznPay)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/group_combination_circuit_breakers", controller.GetGroupCombinationCircuitBreakers)
			optionRoute.POST("/group_combination_circuit_breakers/reset", controller.ResetGroupCombinationCircuitBreaker)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/juice/test", controller.TestChannelJuice)
			channelRoute.PUT("/:id/juice/test", controller.UpdateChannelJuiceTestStatus)
		...
		dataRoute.GET("/group_users", middleware.AdminAuth(), controller.GetQuotaDataUsers)
		dataRoute.GET("/self/groups", middleware.UserAuth(), controller.GetUserQuotaDatesByGroup)
