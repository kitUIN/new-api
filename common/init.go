...
func InitEnv() {
	...
	TicketRateLimitNum = GetEnvOrDefault("TICKET_RATE_LIMIT", 20)
	TicketRateLimitDuration = int64(GetEnvOrDefault("TICKET_RATE_LIMIT_DURATION", 60))
	TicketAttachmentRateLimitNum = GetEnvOrDefault("TICKET_ATTACHMENT_RATE_LIMIT", 240)
	TicketAttachmentRateLimitDuration = int64(GetEnvOrDefault("TICKET_ATTACHMENT_RATE_LIMIT_DURATION", 60))
	initConstantEnv()
}
