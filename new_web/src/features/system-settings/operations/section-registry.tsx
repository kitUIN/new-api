      ...
      <MonitoringSettingsSection
        defaultValues={{
          ...
          'monitor_setting.auto_test_channel_skip_groups':
            settings['monitor_setting.auto_test_channel_skip_groups'],
        }}
      />
    ),
  },
  ...
  },
  {
    ...
    build: (settings: OperationsSettings) => (
      <LogSettingsSection
        ...
        defaultRequestDetailEnabled={Boolean(settings.LogRequestDetailEnabled)}
      />
    ),
  },
  {
  ...
  },
  {
    ...
    build: (
      ...
      <UpdateCheckerSection
        ...
        startTime={startTime}
        githubRepository={settings.GitHubUpdateRepository}
      />
    ),
  },
] as const
