                          ...
                          <div className='flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between'>
                            ...
                            <div className='flex flex-wrap gap-2'>
                              <Button
                                ...
                                size='sm'
                                onClick={() =>
                                  applyBalanceQueryTemplate('newapi')
                                }
                              >
                              ...
                              <Button
                                ...
                                size='sm'
                                onClick={() =>
                                  applyBalanceQueryTemplate('sub2api')
                                }
                              >
                                <Sparkles className='mr-2 h-4 w-4' />
                                {t('sub2api template')}
                            ...
                            <FormField
                              ...
                              render={({ field }) => (
                                <FormItem>
                                  ...
                                  <FormDescription>
                                    {t(
                                      'Default 300 seconds. Set 0 to disable scheduled checks.'
                                    )}
                                  </FormDescription>
                                  <FormMessage />
                                </FormItem>
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                >
                                  ...
                                  <SelectContent alignItemWithTrigger={false}>
                                    <SelectGroup>
                                      {balanceQueryInstanceOptions.map(
                                        (option) => (
                                          <SelectItem
                                            key={option.value}
                                            value={option.value}
                          ...
                          <div className='divide-border space-y-0 divide-y border-y'>
                            ...
                            {(currentType === 1 || currentType === 57) && (
                              <>
                                ...
                                <FormField
                                  control={form.control}
                                  name='responses_web_search_tool_enabled'
                                  render={({ field }) => (
                                    <FormItem className='flex items-center justify-between gap-3 px-4 py-3'>
                                      <div className='space-y-0.5'>
                                        <FormLabel className='text-sm'>
                                          {t(
                                            'Enable Responses web search tool'
                                          )}
                                        </FormLabel>
                                        <FormDescription>
                                          {t(
                                            'Turn off to remove web_search tools before forwarding Responses requests upstream'
                                          )}
                                        </FormDescription>
                                      </div>
                                      <FormControl>
