...
func isVisiblePublicKeyOption(key string) bool {
	switch key {
	case "WaffoPancakeWebhookPublicKey", "WaffoPancakeWebhookTestKey", "XznPayPublicKey":
		return true
	default:
		return false
	}
...
func UpdateOption(c *gin.Context) {
	...
	case "GitHubUpdateRepository":
		...
		option.Value = normalizedRepository
	...
	case "GroupTypes":
		err = ratio_setting.CheckGroupTypes(option.Value.(string))
		if err != nil {
			c.JSON(http.StatusOK, gin.H{
				"success": false,
				"message": err.Error(),
